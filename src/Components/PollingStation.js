    ...
    <Container>
      <Row>
        <Col className='jutify-content-center d-flex'>
          <Container>
            <Row style={{ marginTop: "5vh", backgroundColor: "black" }}>
              <div
                style={{
                  display: "flex",
            ...
            >
              ...
              style={{ backgroundColor: "#D8C091", color: "black", border: '0px'}} 
               onClick={() => addVote(0)}>
                Vote
              </Button>
            </Row>
        ...
        <Col className='jutify-content-center d-flex'>
          <Container>
            ...
            <Row
              ...
              className='justify-content-center d-flex'
            >
              <Button disabled={buttonStatus} style={{ backgroundColor: "#D8C091", color: "black", border: '0px'}} 
              onClick={() => addVote(1)}>
                Vote
              </Button>
            </Row>
