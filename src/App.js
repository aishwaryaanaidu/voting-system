...
import PfwLogo from "./assets/pfw-primary-logo.webp";
      ...
      <Navbar collapseOnSelect expand='lg' bg='dark' variant='dark'>
        <Container>
          ...
          <Navbar.Collapse id='responsive-navbar-nav'>
            ...
            <Nav>
              <Nav.Link href='/NewPoll' style={{ color: 'white'}}>New Poll</Nav.Link>
              <Nav.Link style={{ color: 'white'}} onClick={window.accountId === "" ? login : logout}>
